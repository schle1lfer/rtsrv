...
#define NETLINK_NEIGH_LLADDR_MAX 20
     ...
     * rtnetlink attributes.  Optional attributes that were absent in the
     * message are left zero-initialised.
     */
    typedef struct
    {
        /* ── From struct ndmsg ───────────────────────────────────────────────
        ...
        /* ── NDA_LLADDR ──────────────────────────────────────────────────────
         */
        uint8_t lladdr[NETLINK_NEIGH_LLADDR_MAX]; /**< Raw link-layer address
                                                     bytes  */
     ...
     *        the RTMGRP_NEIGH multicast group (IPv4, IPv6, and bridge
     * neighbors).
     *
    ...
    /**
     * @brief Sends RTM_GETNEIGH dump request and dispatches all existing
     * entries.
     *
     ...
     * out.
     *
     * Call after netlink_neigh_dump() to receive ongoing neighbor change
