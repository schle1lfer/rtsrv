/**
 * @file common/include/common/sot_config.hpp
 * @brief Source-of-Truth (SOT) configuration loader shared by srmd and sra.
 *
 ...
 * is consumed by sra @em before any gRPC connections are opened, and by srmd
 * at startup to seed its desired-state store.
 *
...
struct SotNode
{
     ...
     * stored in @c SwitchEntry::ipv4 in @c switch_config.json so that sra
